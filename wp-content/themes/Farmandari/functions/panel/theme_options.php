...
function simplecatch_options_menu() {
	...
	$simplecatch_options = add_theme_page( 
		sprintf( esc_html__( 'تنظیمات پوسته سایت', 'simplecatch' ), get_bloginfo( 'name') ), // Name of page
		'تنظیمات پوسته سایت',	// Label in menu
	...
	$slider_options = add_menu_page( 
		sprintf( esc_html__( 'تنظیمات اسلایدر', 'simplecatch' ), get_bloginfo( 'name') ), // Name of page
		'تنظیمات اسلایدر',	// Label in menu
...
?>
	<div id="catchthemes" class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            ?>   
            <h2><?php bloginfo( 'name' ) . ' ویرایش شده توسط ' ?><a href="<?php echo esc_url( 'http://www.evazzadeh.com' ); ?>" title="<?php echo 'Javad Evazzadeh' ?>" target="_blank">توسط جواد عوض زاده</a></h2>
            ...
            <div id="simplecatch_ad_tabs">
                <ul class="tabNavigation" id="mainNav">
                    <li><a href="#featuredslider">ویرایش اسلایدر</a></li>
                    <li><a href="#moreslideroptions">سایر تنظیمات اسلایدر</a></li> 
                </ul>       
                ...
                <div id="featuredslider">
                    ...
                    <table class="form-table">
                        <tr>                            
                            <th scope="row"><h4>جلوگیری از نمایش پست های اسلایدر در صفحه نخست</h4></th>
                        ...
                        <tr>
                            <th scope="row"><h4>تعداد اسلایدر</h4></th>
                        ...
                        <tbody class="sortable">
                            ...
                            <tr>
                                <th scope="row"><label class="handle">اسلایدر شماره #<span class="count"><?php echo absint( $i ); ?></span></label></th>
                                ...
                                <a href="<?php bloginfo ( 'url' );?>/wp-admin/post.php?post=<?php if( array_key_exists ( 'featured_slider', $options ) && array_key_exists ( $i, $options[ 'featured_slider' ] ) ) echo absint( $options[ 'featured_slider' ][ $i ] ); ?>&action=edit" class="button" title="برای ویرایش مطلب کلیک کنید" target="_blank">ویرایش خبر</a>
                                </td>
                            </tr> 							
                            <?php endfor; ?>
							</tbody>
                    </table>
					<p>توجه: شما در این بخش می توانید با وارد کردن کد نوشته هایتان آن ها را در اسلایدر صفحه نخست نمایش دهید</p>
                    <p class="submit"><input type="submit" class="button-primary" value="ذخیره کن" /></p> 
                </div> <!-- #featuredslider --> 

                <!-- Option for More Slider Options -->
                <div id="moreslideroptions">
                    <h2>سایر تنظیمات اسلایدر</h2> 
                    <table class="form-table">   
                        <tr>                            
                            <th scope="row"><h4>حذف افکت پس زمینه اسلایدر</h4></th>
                        ...
                        <tr>
                            <th>
                                <label for="simplecatch_cycle_style"><h4>افکت نمایش</label></h4>
                            </th>
                        ...
                        <tr>
                            <th scope="row"><h4>زمان تاخیر بین دو افکت</h4></th>
                            <td>
...
function simplecatch_options_validation( $options ){
    ...
    if( $options[ 'reset_settings' ] == 1 ) {
        $options_validated[ 'more_tag_text' ] = "بیشتر بخوانید";
        $options_validated[ 'search_display_text' ] = "کلمه کلیدی";
        $options_validated[ 'search_button_text' ] = "جستجو"; 
    }
