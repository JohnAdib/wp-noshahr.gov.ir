<?php
/*
Plugin Name: WP JSNews Ticker
Description: A jQuery based news ticker widget.
Version: 2.1
Author: Hassan Derakhshandeh, Javad Evazzadeh
Author URI: http://www.evazzadeh.com
...
class WP_News_Ticker extends WP_Widget {
	...
	function form( $instance ) {
		...
		$titleText = isset( $instance['titleText'] ) ? $instance['titleText'] : __( 'آخرين عناوين', $this->textdomain );
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('displayType'); ?>"><?php _e( 'افکت', $this->textdomain ); ?></label>
		...
		<p>
			<label><input type="checkbox" name="<?php echo $this->get_field_name('controls'); ?>" value="1" <?php echo checked( 1, $instance['controls'] ) ?> /> <?php _e( 'نمايش کنترل ها؟', $this->textdomain ) ?></label>
		</p>
	<?php }
}
